...
namespace ConsoleApp_uselib_Employee_A2
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                Employee e1 = new Employee("tom", 20000);
                e1.Calculate();
                Console.WriteLine("\nID: {0} Name: {1} Netsalary: {2}",e1.ID,e1.Name,e1.Netsalary);

                Employee e2 = new Employee("tod", 30000);
                e2.Calculate();      
                //Employee e2 = new Employee("tod", 75000);                 Invalid Salary
                Console.WriteLine("\nID: {0} Name: {1} Netsalary: {2}",e2.ID,e2.Name,e2.Netsalary);

                Employee e3 = new Employee("john", 40000);
                e3.Calculate();
                Console.WriteLine("\nID: {0} Name: {1} Netsalary: {2}",e3.ID,e3.Name,e3.Netsalary);

               // Employee e4 = new Employee("peter", 20000);               //Max Object creation limit reached.
            }
            catch
            {
